...
<div id="feedbackOverlay" class="feedback-overlay">
  <div class="feedback-form">
    <form id="wpforms-form-8584"
          ...
          action="{{ route('fronted.contact.feedback') }}">
        @csrf
        <div class="card shadow-lg border-0 rounded-4 text-center">
            ...
            <div class="card-body feedback-body p-4">
              ...
              <!-- Name -->
              <div class="mb-3 data">
                <input type="text" id="name" name="name" class="form-control rounded-pill" placeholder="Your Name" required>
              </div>

              <!-- Message -->
              <div class="mb-3 data">
                <textarea id="message" name="message" class="form-control rounded-3" rows="4" placeholder="Your Message" required
                style="min-height: 0em;"></textarea>
              </div>

              <!-- Submit -->
              <div class="mb-2">
<button type="button" id="submitFeedback" class="btn-submit rounded-pill fw-semibold">Submit</button>
              </div>
...
.feedback-overlay.active { visibility: visible; opacity: 1; }
...
.feedback-overlay.active .feedback-form { transform: scale(1); opacity: 1; }
...
document.querySelectorAll('#star-rating .star').forEach(star => {
  star.addEventListener('click', function() {
    ...
    document.querySelectorAll('#star-rating .star').forEach(s => { if(s.getAttribute('data-value') <= value) s.classList.add('selected'); });
  });
});
